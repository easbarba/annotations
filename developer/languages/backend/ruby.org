...
- [[#base][Base]]
  - [[#objects][Objects]]
    ...
    - [[#private_methods--protected_methods][private_methods / protected_methods]]
    - [[#instance-variables][instance variables]]
    - [[#freeze][freeze]]
      - [[#add-the-following-line-to-the-top-of-any-individual-file][Add the following line to the top of any individual file:]]
      - [[#run-your-programs-on-the-command-line-with-a-specific-instruction][Run your programs on the command line with a specific instruction.]]
    - [[#object_id][object_id]]
    - [[#self][self]]
    - [[#methods][methods]]
  ...
  - [[#errors][Errors]]
    ...
    - [[#system-errors][System Errors]]
      - [[#usage][usage]]
  - [[#parallel--concurrency][Parallel / Concurrency]]
    - [[#thread][Thread]]
    - [[#fibers][Fibers]]
      - [[#errors][errors]]
      - [[#usage][usage]]
  ...
  - [[#eval][Eval]]
    ...
    - [[#evals-perils][evals perils]]
    - [[#define_method][define_method]]
  - [[#callbacks--hooks][Callbacks / Hooks]]
    - [[#method_missing][method_missing]]
    - [[#respond_to_missingp][respond_to_missingp]]
  - [[#metaprogramming][Metaprogramming]]
    - [[#instance_variable_set][instance_variable_set]]
    - [[#instance_varibles][instance_varibles]]
    - [[#class][class]]
      - [[#instance_methods][instance_methods]]
    - [[#objectinstance_exec][Object#instance_exec]]
    - [[#moduleclass_exec][Module#class_exec]]
    - [[#modulemodule_exec][Module#module_exec]]
  - [[#misc][Misc]]
    - [[#misc][misc]]
  ...
  - [[#instructions][Instructions]]
    - [[#rbenv][Rbenv]]
    - [[#misc][misc]]
  - [[#builtin-modifications][Builtin Modifications]]
    - [[#additive-change][additive change]]
    - [[#pass-through][Pass-through]]
    - [[#additive--pass-through-hybrids][Additive / Pass-Through Hybrids]]
  - [[#comments][Comments]]
  - [[#delimited-input][Delimited input]]
- [[#standard-library][Standard Library]]
  - [[#packagement][Packagement]]
    - [[#gem][gem]]
  - [[#variables][Variables]]
...
- [[#standard-modules][Standard Modules]]
  ...
  - [[#pathname][Pathname]]
    - [[#new][new]]
    - [[#each_filename][each_filename]]
    - [[#each_entry][each_entry]]
  - [[#objectspade][ObjectSpade]]
  ...
  - [[#kernel][Kernel]]
    - [[#variables][variables]]
      ...
      - [[#itself][itself]]
      - [[#yield_self--then][yield_self / then]]
  ...
  - [[#iterators][Iterators]]
    - [[#collect][collect]]
    - [[#each][each]]
    - [[#selectinject][select/inject]]
    - [[#each_consvalue][each_cons(<value>)]]
    - [[#find][find]]
