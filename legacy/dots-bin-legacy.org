...
wm=(syncthing gopher ssh-askpass-gnome pasystray volumeicon-alsa)
debian=(apt-listbugs apt-listchanges reportbug)
wayland=(sway swaybg swaylock swayidle foot clipman grim slurp xwayland mako-notifier wl-clipboard bemenu wofi)
...
#+end_src
* e-debian-dev
php-curl php-dom php-bcmath php-mbstring php-zip php-xml php-mysql prettier/plugin-php
* wm-autostart
#+begin_src shell
